...
import nf.co.novomic.programlangtest.fragments.QuitDialogFragment;
...
public final class TestActivity extends AppCompatActivity implements QuestionCallbacks {
    ...
    private static final int DEFAULT_MAX_ERRORS = 1;
    ...
    public boolean getLast() {
        return mCurrentQuestion == NUMBER_OF_QUESTIONS;
    }
