 ...
 */
public final class MenuCFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View fragment_view = inflater.inflate(R.layout.fragment_menu_c, container, false);

        // get buttons from activity's layout
        Button btnMenuQuestions = (Button) fragment_view.findViewById(R.id.btn_menu_c_questions);
        Button btnMenuTest = (Button) fragment_view.findViewById(R.id.btn_menu_c_test);
        Button btnMenuReview = (Button) fragment_view.findViewById(R.id.btn_menu_c_review);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_menu_c_questions:
                // open question categories
                startFragment(CategoryListFragment.newInstance(Question.C_TEST));
                break;
            case R.id.btn_menu_c_test:
                ...
                testActivity.putExtra(TestActivity.EXTRA_TEST_TYPE, Question.C_TEST);
                v.getContext().startActivity(testActivity);
                break;
            case R.id.btn_menu_c_review:
                // start question activity with array list of questions
                // from error table
                Intent reviewActivity = new Intent(v.getContext(), ReviewActivity.class);
                reviewActivity.putExtra(TestActivity.EXTRA_TEST_TYPE, Question.C_TEST);
